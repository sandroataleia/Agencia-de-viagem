...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24/09/2024 às 21:21
...
INSERT INTO `agencias` (`id_agencia`, `agencia`, `fk_banco`, `contato`, `endereco`, `numero`, `bairro`, `fk_cidade`, `fk_estado`) VALUES
(5, '5997-8', 1, '', '', '', '', 0, 0),
(7, '573-8', 3, '', '', '', '', 0, 0);
...
--
-- Estrutura para tabela `arq_documentos`
--

CREATE TABLE `arq_documentos` (
  `id_arqdocumentos` int(11) NOT NULL,
  `fk_pasta` int(11) NOT NULL,
  `filename` varchar(500) NOT NULL,
  `descricao_arquivo` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Despejando dados para a tabela `arq_documentos`
--

INSERT INTO `arq_documentos` (`id_arqdocumentos`, `fk_pasta`, `filename`, `descricao_arquivo`) VALUES
(38, 0, '1722255176_ea2dbabb6879271fbdce.png', 'imagem pequena');
...
INSERT INTO `bancos` (`id_banco`, `nome`, `codigo`, `status`) VALUES
(1, 'Banco do Brasil', '001', 1),
(3, 'Bradesco', '237', 1),
(4, 'Caixa economica federal', '104', 1),
(6, 'Conta Interna', '1000', 1);
...
(1, 'Diretor(a)', 'Diretor(a) Executivo', 1),
(3, 'Contabil', 'Contabilidade', 1),
(4, 'Financeiro', ' Setor Financeiro', 1),
(5, 'Vendas', ' Setor de vendas', 1);
...
CREATE TABLE `clientes` (
  ...
  `fone_emergencia` varchar(20) NOT NULL,
  `fk_pessoa` int(11) NOT NULL DEFAULT 1,
  `status` int(11) NOT NULL DEFAULT 1,
  `enderecosec` varchar(250) NOT NULL,
  `numerosec` varchar(10) NOT NULL,
  `bairrosec` varchar(100) NOT NULL,
  `cepsec` varchar(15) NOT NULL,
  `estadosec` varchar(100) NOT NULL,
  `cidadesec` varchar(100) NOT NULL,
  `paissec` varchar(100) NOT NULL,
  `cpf` varchar(15) NOT NULL,
  `complementosec` varchar(50) NOT NULL,
...
INSERT INTO `clientes` (`id_cliente`, `numero_passaporte`, `contato_emergencia`, `fone_emergencia`, `fk_pessoa`, `status`, `enderecosec`, `numerosec`, `bairrosec`, `cepsec`, `estadosec`, `cidadesec`, `paissec`, `cpf`, `complementosec`, `grau_parentesco`, `validade_passaporte`, `nacionalidade`, `fk_usuario`, `ultima_alteracao`, `data_ultima_alteracao`) VALUES
(33, '25454515545', 'fadfadfa', '3322551122', 1, 1, 'a', 'a', 'a', '39850000', 'a', 'a', 'a', '1212112121', '', NULL, NULL, NULL, 0, 0, NULL),
(34, '32654651346546', 'Maria Augusta Ramos', '15 2655-3555', 1, 1, 'Rua b', '255 C', 'Zona Sul', '29800000', 'Goias', 'Goiania', 'Brasil', '0152111452', 'Apartamento', 'Irmã', '2035-05-20', 'brasileira', 0, 6, NULL),
(35, '', '', '', 1, 1, '', '', '', '', '', '', '', '0211220255', '', NULL, NULL, NULL, 6, 0, NULL);
...
CREATE TABLE `contas` (
  ...
  `status` int(11) NOT NULL DEFAULT 1,
  `fk_tipoconta` int(11) NOT NULL,
  `cheque_especial` decimal(15,2) NOT NULL,
...
INSERT INTO `contas` (`numero_conta`, `fk_agencia`, `saldo_inicial`, `status`, `fk_tipoconta`, `cheque_especial`, `saldo_atual`, `id_conta`, `fk_banco`) VALUES
('6555', 5, 55000.33, 1, 1, 10322.36, 3177.79, 9, 1),
('723', 5, 22352.32, 1, 2, 10000.00, 3330.86, 10, 1),
('5452121', 7, 200.22, 1, 3, 322.12, 3050.43, 12, 3);
...
INSERT INTO `contatos` (`id`, `fk_pessoa`, `fone`) VALUES
(1, 1, '33999280552');

-- --------------------------------------------------------

--
-- Estrutura para tabela `conta_interna`
--
...
--
-- Estrutura para tabela `cpagamentos`
--

CREATE TABLE `cpagamentos` (
  `id_cpagamento` int(11) NOT NULL,
  `condicao` varchar(30) NOT NULL,
  `status` int(11) NOT NULL,
  `id_fpagamento` int(11) NOT NULL,
  `prazo` int(11) NOT NULL,
  `qtde_parcelas` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Despejando dados para a tabela `cpagamentos`
--

INSERT INTO `cpagamentos` (`id_cpagamento`, `condicao`, `status`, `id_fpagamento`, `prazo`, `qtde_parcelas`) VALUES
(3, '1x parcela', 1, 1, 30, 1),
(5, '3x parcelas', 1, 1, 90, 3),
(6, '4x parcelas', 1, 1, 120, 4),
(7, '5x parcelas', 1, 1, 150, 5),
(9, '6x parcelas', 1, 1, 180, 6),
(12, '7x parcelas', 1, 1, 210, 7),
(13, '8x parcelas', 1, 1, 240, 8),
(16, '2x parcelas', 1, 1, 60, 2),
(17, '1x parcela', 1, 11, 30, 1),
(18, '', 1, 0, 0, 0),
(19, '', 1, 0, 0, 0);
...
INSERT INTO `empresa` (`id_empresa`, `razao_social`, `fantasia`, `cnpj`, `inscricao_estadual`, `inscricao_municipal`, `logo`) VALUES
(1, 'PATRICIA ALVES RIBEIRO', 'PATRICIA RIBEIRO VIAGENS NACIONAIS E INTERNACIONAIS', '47.180.546/0001-35', '43924190046', '', '1720122842_aa7683764a59bb9a900f.png');
...
INSERT INTO `estados` (`id`, `nome_estado`, `uf`, `ibge`, `pais`, `ddd`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
CREATE TABLE `fornecedor` (
  ...
  `usu_cadastro` int(11) NOT NULL,
  `usu_alteracao` int(11) NOT NULL,
  `cpf_cnpj` varchar(20) NOT NULL,
  `fantasia` varchar(100) NOT NULL,
  `tipo_fornecedor` int(11) NOT NULL,
  `inscricao_estadual` varchar(20) NOT NULL,
  `inscricao_municipal` varchar(20) NOT NULL,
  `status` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `fornecedor` (`id_fornecedor`, `fk_filial`, `data_cadastro`, `usu_cadastro`, `usu_alteracao`, `cpf_cnpj`, `fantasia`, `tipo_fornecedor`, `inscricao_estadual`, `inscricao_municipal`, `status`) VALUES
(1, 0, '2024-07-08 10:48:00', 0, 0, '01222554545', 'Cemig', 0, '13213213', '3213213', 1),
(2, 0, '2024-07-08 10:52:01', 0, 0, '21542121', 'Copasa', 0, '', '', 1),
(3, 0, '2024-07-08 10:52:35', 0, 0, '', 'Fastnet', 0, '', '', 1);

-- --------------------------------------------------------

--
-- Estrutura para tabela `fpagamentos`
--

CREATE TABLE `fpagamentos` (
  `id_fpagamento` int(11) NOT NULL,
  `parcelas` int(11) NOT NULL,
  `descricao_fpagamento` varchar(50) NOT NULL,
  `status` int(11) NOT NULL DEFAULT 1,
  `tempo_pagamento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Despejando dados para a tabela `fpagamentos`
--

INSERT INTO `fpagamentos` (`id_fpagamento`, `parcelas`, `descricao_fpagamento`, `status`, `tempo_pagamento`) VALUES
(27, 1, 'Cartão de débito', 1, 0),
(28, 1, 'Pix', 1, 0),
(29, 1, 'Cartão de crédito a vista', 1, 30),
(32, 2, 'Cartão de crédito 2x parcelas', 1, 60),
(33, 3, 'Cartão de crédito 3x parcelas', 1, 90),
(34, 4, 'Cartão de crédito 4x parcelas', 1, 120);
...
INSERT INTO `funcionarios` (`id_funcionario`, `cpf`, `salario`, `fk_cargo`, `dt_cadastro`, `status`) VALUES
(14, '434343', NULL, 5, '2024-07-30', 1),
(16, '4434134123', NULL, 5, '2024-07-30', 1),
(19, '3132421', NULL, 5, '2024-07-30', 1),
(21, '09162220632', NULL, 5, '2024-07-30', 1);
...
CREATE TABLE `movimentacao_estoque` (
  ...
  `fk_tipo_movimentacao` int(11) NOT NULL,
  `fk_usuario` int(11) NOT NULL,
...
CREATE TABLE `movimentacao_financeira` (
  ...
  `entrada_saida` varchar(8) NOT NULL,
  `numero_conta` varchar(20) NOT NULL,
  `valor` double(10,2) NOT NULL,
  `data` date NOT NULL DEFAULT current_timestamp(),
  `fpagamento` varchar(15) NOT NULL,
  `banco` varchar(35) NOT NULL,
  `conciliado` int(11) NOT NULL,
...
INSERT INTO `movimentacao_financeira` (`id_movimentacao`, `entrada_saida`, `numero_conta`, `valor`, `data`, `fpagamento`, `banco`, `conciliado`, `cliente_fornecedor`, `tipo`, `descricao`) VALUES
(19, 'entrada', '6555', 2000.00, '2024-07-18', 'transferencia', 'Banco do Brasil', 1, 'Sandro Pereira dos Santos', '', ''),
(20, 'entrada', '723', 800.00, '2024-07-19', 'pix', 'Banco do Brasil', 1, 'Sandro Pereira dos Santos', '', ''),
(21, 'saida', '6555', 122.21, '2024-07-19', 'cartão de crédi', 'Banco do Brasil', 0, 'Cemig', 'Boleto bancário', ''),
(22, 'saida', '6555', 200.00, '2024-07-19', 'cartão de crédi', 'Banco do Brasil', 1, 'Cemig', 'Boleto bancário', ''),
(23, 'saida', '6555', 122.21, '2024-07-19', 'cartão de crédi', 'Banco do Brasil', 1, 'Cemig', 'Boleto bancário', ''),
(24, 'entrada', '6555', 0.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(25, 'entrada', '6555', 0.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(26, 'entrada', '6555', 0.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(27, 'entrada', '6555', 0.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(28, 'entrada', '6555', 0.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(29, 'entrada', '6555', 0.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(30, 'entrada', '6555', 1524.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(31, 'entrada', '6555', 1524.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(32, 'entrada', '6555', 125.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(33, 'entrada', '6555', 300.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(34, 'entrada', '6555', 300.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(35, 'entrada', '6555', 300.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(36, 'entrada', '6555', 300.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(37, 'entrada', '6555', 300.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(38, 'entrada', '6555', 300.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(39, 'entrada', '6555', 300.00, '2024-08-15', 'Cartão de débit', 'Banco do Brasil', 0, 'Sandro Pereira dos Santos', 'Recebimento cliente', ''),
(40, 'entrada', '6555', 1000.00, '2024-08-16', 'Cartão de débit', 'Banco do Brasil', 0, 'joana ', 'Recebimento cliente', ''),
(41, 'entrada', '6555', 1000.00, '2024-08-16', 'Cartão de débit', 'Banco do Brasil', 0, 'joana ', 'Recebimento cliente', '');

-- --------------------------------------------------------

--
-- Estrutura para tabela `operadora_cartoes`
--

CREATE TABLE `operadora_cartoes` (
  `id_operadora` int(11) NOT NULL,
  `operadora` varchar(100) NOT NULL,
  `dias_prepasse` int(11) DEFAULT NULL,
  `dias_repasse` int(11) DEFAULT NULL,
  `status` int(11) NOT NULL DEFAULT 1,
  `nome_cliente_operadora` varchar(100) DEFAULT NULL,
...
--
-- Despejando dados para a tabela `operadora_cartoes`
--

INSERT INTO `operadora_cartoes` (`id_operadora`, `operadora`, `dias_prepasse`, `dias_repasse`, `status`, `nome_cliente_operadora`, `endereco`, `numero`, `bairro`, `cidade`, `cep`, `pais`, `estado`, `cnpj`) VALUES
(2, 'Pag Seguro', 0, 1, 1, '', 'Av. PrefeitoClemente Esteves Feraz', '6555', 'Vila Luciene', 'Barra de São Francisco', 29800000, 'Brasil', 'ES', '451212165465'),
(4, 'stone', NULL, 14, 1, NULL, '', '', '', 'Barra de São Francisco', 29800000, '', 'ES', '11221122'),
(5, '', NULL, NULL, 1, NULL, NULL, '4544-2', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `paises` (`id`, `nome_pais`, `nome_pt`, `sigla`, `bacen`) VALUES
...
INSERT INTO `parceiros` (`id_parceiros`, `cpf`, `nome_parceiro`) VALUES
(2, '01525542111', 'João Marcelo de Souza');
...
CREATE TABLE `pastas` (
  ...
  `descricao_pasta` varchar(100) NOT NULL,
  `cpf` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `pastas` (`id_pasta`, `descricao_pasta`, `cpf`) VALUES
(3, 'Documentos', '1212112121'),
(6, 'Notas Fiscais', '0152111452');
...
(2, 'Clientes', 'Acesso cadastros'),
(5, 'Viagem', 'Acesso a viagens'),
(6, 'Finanças', 'Acessar financeiro'),
(7, 'Contábil', 'Acessar Contabil'),
(8, 'Usuário', 'Acessar usuários'),
(9, 'Configurações', 'Acessar Configurações'),
(10, 'Relatórios', 'Acessar relatórios'),
(11, 'Funcionarios', 'Tabela de funcionarios'),
...
(21, 'Perfil de usuario', 'Uusuário'),
(22, 'Configuração da empresa', ''),
(23, 'Fornecedor', ''),
(24, 'Parceiro', ''),
(25, 'Vendas', 'Acessar todos os itens de venda');
...
INSERT INTO `perfil_usuario` (`id_perfil_usuario`, `fk_perfil`, `fk_usuario`) VALUES
(1, 2, 6),
(5, 6, 6),
(6, 10, 6),
(7, 13, 6),
...
INSERT INTO `pessoas` (`id`, `nome`, `rg`, `cpf`, `email`, `dtnascimento`, `sexo`, `telefone`, `endereco`, `numero`, `complemento`, `bairro`, `estado`, `cep`, `pais`, `cidade`, `status`) VALUES
(1, 'Sandro Pereira dos Santos', '', '09162220632', '', '2024-07-03', 'm', '', '', '', '', '', '', 0, '', '', 1),
(8, 'thaine', 'mg14227798', '09671795641', 'sandroataleia@gmail.com', '2024-04-03', 'f', '33 98544121', '', '', '', '', '', 0, '0', 'Barra de São Francisco', 1),
(10, 'sandro', 'mg14227798', '09162220635', 'sandroataleia@gmail.com', '2024-04-10', 'm', '3388544136', '', '', '', '', '', 0, '0', '', 1),
(14, 'Fernando', 'mg45545421', '09554446221', 'teste@teste.com', '0000-00-00', 'M', '33 99925-5412', 'rua a', '54', '', 'adf', 'mg', 29800000, '0', 'belo horizonte', 1),
(17, 'Maria Isabel', 'mg14227798', '88554411', 'suporte@alvesshopping.com.br', '2024-05-01', 'f', '54654654', 'fasdfad', '6555', '', 'Acari', 'ES', 29800000, '0', 'Barra de São Francisco', 1),
(18, 'fasdfasdf', '452452', '09162220645', 'suporte@alvesshopping.com.br', '2024-05-02', 'm', '54654654', 'fasdf', '723', '', 'Vila Luciene', 'ES', 29800000, '21', 'Barra de São Francisco', 1),
(19, 'fasdfasdf', '452452', '02255541200', 'suporte@alvesshopping.com.br', '2024-05-02', 'm', '54654654', 'fasdf', '723', '', 'Vila Luciene', 'ES', 29800000, '21', 'Barra de São Francisco', 1),
(20, 'fasdfasdf', '452452', '456666677', 'suporte@alvesshopping.com.br', '2024-05-02', 'm', '54654654', 'fasdf', '723', '', 'Vila Luciene', 'ES', 29800000, '21', 'Barra de São Francisco', 1),
(21, 'fasdfasdf', '452452', '11122211145', 'suporte@alvesshopping.com.br', '2024-05-02', 'm', '54654654', 'fasdf', '723', '', 'Vila Luciene', 'ES', 29800000, '21', 'Barra de São Francisco', 1),
(22, 'joana ', 'sp542211', '1144116565', 'teste@teste', '0000-00-00', 'm', '2154556633', '', '', '', '', '', 0, '0', '', 1),
(23, '', '', '110001144', '', '0000-00-00', 'm', '', '', '', '', '', '', 0, '0', '', 1),
(24, 'fasdfasdf', 'mg1002254', '11554455', 'suporte@alvesshopping.com.br', '2024-05-02', 'f', '2221111', 'fasdfad', '723', '', 'Vila Luciene', 'asdf', 29800000, '21', 'Barra de São Francisco', 1),
(31, 'Maria Isabel', 'mg14227798', '09162220639', 'contato@hugocursos.com.br', '2024-05-01', 'f', '54654654', 'Av. PrefeitoClemente Esteves Feraz', '6555', '', 'Vila Luciene', 'MG', 39850000, '0', 'Ataléia', 1),
(32, 'adf', 'mg1002254', '05221112002', 'vendas1@alvesshopping.com.br', '2024-05-01', 'f', '33 99925-5412', 'Av. PrefeitoClemente Esteves Feraz', '6555', '', 'Vila Luciene', 'ES', 29800000, '0', 'Barra de São Francisco', 1),
(33, 'Maria Isabel', 'asdf', '12121121212', '', '0000-00-00', 'm', '', '', '', '', '', '', 0, '0', '', 1),
(34, 'adfad', 'asdfad', '02552212002', 'sandroataleia@gmail.com', '2024-05-02', 'f', '33 99925-5412', '', '', '', '', 'MG', 39850000, '0', 'Ataléia', 1),
(42, 'Livia', 'mg212211', '02122201541', 'admin@admin.com', '1987-02-01', 'f', '33 2654-6655', 'a', 'a', '', 'a', 'ES', 29800000, '0', 'Barra de São Francisco', 1),
(43, 'Joao', 'mg2552223', '02154445222', 'joao@gmail.com', '1985-05-21', 'm', '31999255445', 'Rua Governador Valadares', '125', '', 'Centro', 'MG', 39850000, 'Brasil', 'Ataléia', 1),
(44, 'Clarice', 'mg454554544', '0566555244', 'email@email.com', '1985-12-15', 'f', '33988522555', '', '', '', '', 'ES', 29850000, '', 'Ecoporanga', 1),
(45, 'sandro', 'asdfad', '09162220631', '', '2024-06-04', 'm', '', '', '', '', '', '', 0, '', '', 1),
(46, 'Maria Isabel', 'fad121212', '012212121', 'email@email.com', '1952-02-10', 'f', '3355221312', 'a', 'a', '', 'a', 'ES', 29800000, 'a', 'Barra de São Francisco', 1),
(47, 'Maria Isabel Ferreira de Souza', 'mg14227798', '1212112121', 'admin@admin.com', '2024-07-01', 'f', '54654654', 'a', 'a', '', 'a', 'ES', 29800000, 'a', 'Barra de São Francisco', 1),
(48, 'Jose Carlos de Amorin', '2544112', '0152111452', 'jose@email.com', '1965-04-25', 'm', '15 2655-2544', 'Rua a', '322 A', 'Casa', 'Centro', 'MG', 39850000, 'Brasil', 'Ataléia', 1),
(49, 'asdfasdf', '143134', '342-34234', 'site@email.com', '2024-07-10', 'f', '(13) 2412-3412', 'asdfasdf', 'asdf', '', 'asdfasda', 'ES', 29850000, 'sdfasd', 'Ecoporanga', 1),
(50, 'afsdfadsfd', '452452', '423432423423', 'site@site.com', '2024-07-04', 'f', '(24) 3234-2342', 'fadf', 'asdf', '', 'asdfa', 'ES', 29800000, 'sdfa', 'Barra de São Francisco', 1),
(51, 'fasdfasdf', 'asdf', '234234234', 'sandroataleia@gmail.com', '2024-07-03', 'm', '(24) 3524-3524', 'asdfa', 'asdf', '', 'asdf', 'ES', 29800000, 'fadsf', 'Barra de São Francisco', 1),
(52, 'asdfadsf', 'asdf', '434343', '', '2024-07-02', 'm', '(32) 1321-3213', '', '', '', '', '', 0, '', '', 1),
(53, 'asdfasdf', 'asdf', '4334343', '', '2024-07-10', 'f', '', '', '', '', '', '', 0, '', '', 1),
(54, 'asdfasdfa', 'fasdfasd', '4434134123', '', '2024-07-02', 'm', '(13) 2132-1321', 'Av. PrefeitoClemente Esteves Feraz', '', '', '', '', 39850000, '', '', 1),
(55, 'asdfasdfadf', '', '1411414', '', '2024-07-11', 'm', '', '', '', '', '', '', 0, '', '', 1),
(56, 'asdfasdfasd', '', '42342341234', '', '2024-07-10', 'm', '', '', '', '', '', '', 0, '', '', 1),
(57, 'fadfadfa', '', '3132421', '', '2024-07-02', 'm', '', '', '', '', '', '', 0, '', '', 1),
(58, 'asdfasdf', '', '413412341', '', '2024-07-01', 'm', '', '', '', '', '', '', 0, '', '', 1),
(60, 'sfdgsdfgsf', '', '423423', '', '2024-07-17', 'f', '', '', '', '', '', '', 0, '', '', 1),
(61, 'Maria do Carmo Alves', '13213213', '0211220255', NULL, NULL, NULL, '3355222332', NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, 1),
(62, 'Maria do Carmo Alves', '1321', '31321321', NULL, NULL, NULL, '31321', NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, 1),
(63, 'João Marcelo de Souza', '2154545', '01525542111', NULL, NULL, NULL, '33 3526-1525', NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, 1);
...
INSERT INTO `profile` (`id`, `descricao`, `perfil`, `status`) VALUES
(1, 'Usuário com acesso total ao sistema.', 'admin', 1),
(2, 'Usuário com acesso básico ao sistema', 'usuario', 1);

-- --------------------------------------------------------

--
-- Estrutura para tabela `tipo_contas`
--
...
--
-- Despejando dados para a tabela `tipo_contas`
--

INSERT INTO `tipo_contas` (`id_tipo_conta`, `descricao_tipo`, `status`) VALUES
(1, 'Corrente', 1),
(2, 'Poupança', 1),
(3, 'Interna', 1),
(4, 'Aplicação', 1),
(5, 'Corrente/Poupança', 1);

-- --------------------------------------------------------

--
-- Estrutura para tabela `tipo_viagem`
--

CREATE TABLE `tipo_viagem` (
  `id_tviagem` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `tipo_viagem`
--

INSERT INTO `tipo_viagem` (`id_tviagem`, `tipo`, `status`, `descricao`) VALUES
(1, 'Cruzeiro', 1, 'Passeio em veículo aquático'),
(3, 'Avião', 1, 'Voo');

-- --------------------------------------------------------

--
-- Estrutura para tabela `titulo_pagar`
--

CREATE TABLE `titulo_pagar` (
  `id_cpagar` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `titulo_pagar`
--

INSERT INTO `titulo_pagar` (`id_cpagar`, `valor`, `dt_vencimento`, `dt_pagamento`, `situacao`, `fk_usuario`, `nome`, `obs`, `dt_lancamento`, `tipo`, `fk_fornecedor`) VALUES
(4, 115.00, '2024-06-27', '2024-07-08', 'lq', 0, 'Conta de agua', 'Pagar na data pra nao cobrar juros.', '2024-06-25', 'df', 1),
(11, 122.21, '2024-07-10', '2024-07-19', 'lq', 0, 'Conta de agua', '', '2024-07-08', '2', 2),
(13, 200.00, '2024-07-20', '2024-07-19', 'lq', 0, 'internet', '', '2024-07-19', '', 1),
(15, 122.21, '2024-07-19', '2024-07-19', 'lq', 0, 'fasdfadsf', '', '2024-07-19', '', 1);

-- --------------------------------------------------------

--
-- Estrutura para tabela `titulo_receber`
--

CREATE TABLE `titulo_receber` (
  `id_creceber` int(11) NOT NULL,
  `cpf` varchar(15) NOT NULL,
  `fk_usuario` int(11) NOT NULL,
  ...
  `valor_aberto` decimal(15,2) NOT NULL,
  `fk_venda` int(11) NOT NULL,
  `valor_original` decimal(15,2) NOT NULL,
  `fk_fpagamento` int(11) NOT NULL,
  `fk_usuario_baixa` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Despejando dados para a tabela `titulo_receber`
--

INSERT INTO `titulo_receber` (`id_creceber`, `cpf`, `fk_usuario`, `data_vencimento`, `data_lancamento`, `situacao`, `data_pagamento`, `valor_pago`, `valor_aberto`, `fk_venda`, `valor_original`, `fk_fpagamento`, `fk_usuario_baixa`) VALUES
(10, '09162220632', 6, '2024-11-12', '2024-08-14', 1, '2024-08-15', 0.00, 0.00, 63, 300.75, 0, 0),
(11, '09162220632', 6, '2024-10-13', '2024-08-14', 0, NULL, 0.00, 300.75, 63, 300.75, 0, 0),
(12, '09162220632', 6, '2024-09-13', '2024-08-14', 1, '2024-08-15', 300.75, 0.00, 63, 300.75, 0, 0),
(13, '09162220632', 6, '2024-08-14', '2024-08-14', 1, '2024-08-15', 1524.55, 0.00, 64, 1524.55, 0, 0),
(14, '09162220632', 6, '0000-00-00', '2024-08-14', 1, '2024-08-15', 125.56, 0.00, 64, 125.56, 0, 0),
(15, '1144116565', 2147483647, '2024-09-15', '2024-08-16', 1, '2024-08-16', 1000.00, 0.00, 65, 1000.00, 29, 0),
(16, '1144116565', 2147483647, '2024-08-16', '2024-08-16', 1, '2024-08-16', 1000.00, 0.00, 66, 1000.00, 27, 0),
(17, '09162220632', 2147483647, '2024-09-25', '2024-08-26', 0, NULL, 0.00, 1850.58, 67, 1850.58, 29, 0),
(18, '09162220631', 2147483647, '2024-11-24', '2024-08-26', 0, NULL, 0.00, 766.67, 68, 766.67, 33, 0),
(19, '09162220631', 2147483647, '2024-10-25', '2024-08-26', 0, NULL, 0.00, 766.67, 68, 766.67, 33, 0),
(20, '09162220631', 2147483647, '2024-09-25', '2024-08-26', 0, NULL, 0.00, 766.67, 68, 766.67, 33, 0),
(21, '09554446221', 2147483647, '2024-12-24', '2024-08-26', 0, NULL, 0.00, 462.65, 69, 462.65, 34, 0),
(22, '09554446221', 2147483647, '2024-11-24', '2024-08-26', 0, NULL, 0.00, 462.65, 69, 462.65, 34, 0),
(23, '09554446221', 2147483647, '2024-10-25', '2024-08-26', 0, NULL, 0.00, 462.65, 69, 462.65, 34, 0),
(24, '09554446221', 2147483647, '2024-09-25', '2024-08-26', 0, NULL, 0.00, 462.65, 69, 462.65, 34, 0),
(25, '09162220632', 2147483647, '2024-11-15', '2024-09-16', 0, NULL, 0.00, 1627.13, 70, 1627.13, 32, 0),
(26, '09162220632', 2147483647, '2024-10-16', '2024-09-16', 0, NULL, 0.00, 1627.13, 70, 1627.13, 32, 0),
(27, '09162220632', 2147483647, '2024-11-15', '2024-09-16', 0, NULL, 0.00, 1627.13, 71, 1627.13, 32, 0),
(28, '09162220632', 2147483647, '2024-10-16', '2024-09-16', 0, NULL, 0.00, 1627.13, 71, 1627.13, 32, 0),
(29, '09162220632', 2147483647, '2024-09-16', '2024-09-16', 0, NULL, 0.00, 902.25, 72, 902.25, 27, 0);
...
CREATE TABLE `users` (
  ...
  `cpf` varchar(15) NOT NULL,
  `status_users` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `users` (`id_usuario`, `user`, `password`, `cpf`, `status_users`, `nome_usuario`) VALUES
(6, 'master', '202cb962ac59075b964b07152d234b70', '09162220632', 1, 'Master');
...
CREATE TABLE `vendas` (
  ...
  `tipo_venda` varchar(25) DEFAULT NULL,
  `data_venda` date NOT NULL DEFAULT current_timestamp(),
  `fk_fpagamento` int(11) NOT NULL,
  `cpf` varchar(15) NOT NULL,
  `valor_bruto` double(10,2) NOT NULL,
  `desconto` double(10,2) NOT NULL,
  `tipo_viagem` varchar(1) DEFAULT NULL,
  `volta_caucao` int(11) DEFAULT NULL,
  `valor_voltacaucao` double(10,2) DEFAULT NULL,
  `origem` varchar(100) DEFAULT NULL,
  `destino` varchar(100) DEFAULT NULL,
  `data_viagem` date DEFAULT NULL,
  `obs` text DEFAULT NULL,
  `cia_aerea` varchar(100) DEFAULT NULL,
  `cod_reserva` varchar(50) DEFAULT NULL,
  `ind_comp` varchar(100) DEFAULT NULL,
  `dt_emissao_passagem` date DEFAULT NULL,
  `milheiro` varchar(100) DEFAULT NULL,
  `fk_usuario` varchar(15) DEFAULT NULL,
  `seguro_viagem` int(11) DEFAULT NULL,
  `empresa_navio` varchar(100) DEFAULT NULL,
  `hora_viagem` time DEFAULT NULL,
  `local_escala` varchar(100) DEFAULT NULL,
  `ultima_alteracao` int(11) DEFAULT NULL,
  `milha` int(11) DEFAULT NULL,
  `data_ultima_alteracao` date DEFAULT NULL,
  `hora_embarque` time DEFAULT NULL,
  `tempo_voo` time DEFAULT NULL,
  `fk_parceiro` int(11) DEFAULT 0,
...
INSERT INTO `vendas` (`id_venda`, `seguradora`, `valor_liquido`, `tipo_venda`, `data_venda`, `fk_fpagamento`, `cpf`, `valor_bruto`, `desconto`, `tipo_viagem`, `volta_caucao`, `valor_voltacaucao`, `origem`, `destino`, `data_viagem`, `obs`, `cia_aerea`, `cod_reserva`, `ind_comp`, `dt_emissao_passagem`, `milheiro`, `fk_usuario`, `seguro_viagem`, `empresa_navio`, `hora_viagem`, `local_escala`, `ultima_alteracao`, `milha`, `data_ultima_alteracao`, `hora_embarque`, `tempo_voo`, `fk_parceiro`, `motivo_cancelamento`, `status`, `inicio_vigencia`, `fim_vigencia`, `retirada`, `entrega`, `hotel`, `emissao`, `validade`, `protocolo`) VALUES
(61, NULL, 1850.58, 'Passagem Aérea', '2024-08-13', 16, '09162220632', 0.00, 0.00, 'i', 0, 0.00, 'teofilo otoni', 'soao paulo', '2024-09-18', '', 'brasiltur', '54542112', NULL, '2024-08-13', 'Um milhao', '09162220632', 1, NULL, '12:00:00', 'belo horizonte', NULL, 1, NULL, '12:00:00', '12:00:00', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(62, NULL, 1850.58, 'Passagem Aérea', '2024-08-13', 1, '09162220632', 0.00, 0.00, 'i', 0, 0.00, 'sao paulo', 'teofilo otoni', '2024-09-18', '', 'brasiltur', '226652265', NULL, '0000-00-00', '0', '09162220632', 0, NULL, '14:00:00', 'belo horizonte', NULL, 0, NULL, '13:00:00', '13:00:00', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(63, NULL, 902.25, 'Passagem Aérea', '2024-08-14', 33, '09162220632', 0.00, 0.00, 'i', 1, 125.56, 'Portugal', 'Brasil', '2024-08-07', 'fasdfasdfadf', 'afdsf', '65465465', NULL, '2024-12-15', '0', '09162220632', 0, NULL, '02:00:00', 'frança', NULL, 0, NULL, '02:00:00', '02:00:00', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(64, NULL, 1524.55, 'Passagem Aérea', '2024-08-14', 28, '09162220632', 0.00, 0.00, 'i', 1, 125.56, 'fasdf', 'asdf', '2024-08-15', '', 'asdfasdf', 'a665465', NULL, '2024-08-14', '0', '09162220632', 0, NULL, '05:00:00', 'asdf', NULL, 0, NULL, '05:00:00', '05:00:00', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(65, NULL, 1000.00, 'Passagem Aérea', '2024-08-16', 29, '1144116565', 0.00, 0.00, 'i', 0, 0.00, 'Brasilia', 'rio grande do sul', '2024-08-16', 'Nada a obsservar.', 'Gol', '21321354', NULL, '2024-08-16', 'Mil milhas', '09162220632', 1, NULL, '14:10:00', 'sao paulo', NULL, 1, NULL, '14:00:00', '01:00:00', 2, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(66, NULL, 1000.00, 'Passagem Aérea', '2024-08-16', 27, '1144116565', 0.00, 0.00, 'v', 0, 0.00, 'Rio grande do sul', 'brasilia', '2024-08-16', 'fasdf', 'gol', '654654654', NULL, '2024-08-16', '0', '09162220632', 0, NULL, '15:20:00', 'sao paulo', NULL, 0, NULL, '15:00:00', '01:00:00', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(67, 'campeao', 1850.58, 'Seguro Viagem', '2024-08-26', 29, '09162220632', 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '09162220632', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(68, 'asdfasdfasdfasdfadf', 2300.00, 'Seguro Viagem', '2024-08-26', 33, '09162220631', 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '09162220632', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(69, NULL, 1850.58, 'Aluguel Carro', '2024-08-26', 34, '09554446221', 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '09162220632', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(70, NULL, 3254.25, 'Passagem Aérea', '2024-09-16', 32, '09162220632', 0.00, 0.00, 'i', 0, 0.00, 'Salvador - Bahia', 'Sao Paulo - SP', '2024-09-16', 'Não estão levando bagagem.', 'Rapidex', '45645654654', NULL, '2024-09-15', 'Mil milhas', '09162220632', 1, NULL, '09:15:00', 'belo horizonte - MG', NULL, 1, NULL, '09:08:00', '00:20:00', 2, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(71, NULL, 3254.25, 'Passagem Aérea', '2024-09-16', 32, '09162220632', 0.00, 0.00, 'v', 0, 0.00, 'Sao Paulo - SP ', 'Salvador - Bahia', '2024-09-16', '', 'Rapidex', '5465465', NULL, '2024-09-15', '0', '09162220632', 0, NULL, '10:05:00', 'belo horizonte - MG', NULL, 0, NULL, '10:00:00', '00:20:00', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(72, NULL, 902.25, 'Passagem Aérea', '2024-09-16', 27, '09162220632', 0.00, 0.00, 'i', 0, 0.00, 'Salvador - Bahia', 'Sao Paulo - SP', '2024-09-16', '', 'nova', '654654', NULL, '2024-09-16', '0', '09162220632', 0, NULL, '10:55:00', 'belo horizonte', NULL, 0, NULL, '10:54:00', '00:10:00', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Índices de tabela `arq_documentos`
--
ALTER TABLE `arq_documentos`
  ADD PRIMARY KEY (`id_arqdocumentos`);
...
--
-- Índices de tabela `conta_interna`
--
ALTER TABLE `conta_interna`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `cpagamentos`
--
ALTER TABLE `cpagamentos`
  ADD PRIMARY KEY (`id_cpagamento`);
...
ALTER TABLE `entradas_saidas`
  ADD PRIMARY KEY (`id_entradas_saidas`);
...
--
-- Índices de tabela `fpagamentos`
--
ALTER TABLE `fpagamentos`
  ADD PRIMARY KEY (`id_fpagamento`);
...
--
-- Índices de tabela `operadora_cartoes`
--
ALTER TABLE `operadora_cartoes`
...
--
-- Índices de tabela `tipo_contas`
--
ALTER TABLE `tipo_contas`
  ADD PRIMARY KEY (`id_tipo_conta`);

--
-- Índices de tabela `tipo_viagem`
--
ALTER TABLE `tipo_viagem`
  ADD PRIMARY KEY (`id_tviagem`);

--
-- Índices de tabela `titulo_pagar`
--
ALTER TABLE `titulo_pagar`
  ADD PRIMARY KEY (`id_cpagar`);

--
-- Índices de tabela `titulo_receber`
--
ALTER TABLE `titulo_receber`
  ADD PRIMARY KEY (`id_creceber`);
...
ALTER TABLE `users`
  ...
  ADD UNIQUE KEY `users_email_unique` (`user`);
...
--
ALTER TABLE `agencias`
  MODIFY `id_agencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `arq_documentos`
--
ALTER TABLE `arq_documentos`
  MODIFY `id_arqdocumentos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
-- AUTO_INCREMENT de tabela `conta_interna`
--
ALTER TABLE `conta_interna`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `cpagamentos`
--
ALTER TABLE `cpagamentos`
  MODIFY `id_cpagamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `entradas_saidas`
  MODIFY `id_entradas_saidas` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `fpagamentos`
--
ALTER TABLE `fpagamentos`
  MODIFY `id_fpagamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT de tabela `funcionarios`
--
ALTER TABLE `funcionarios`
  MODIFY `id_funcionario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
-- AUTO_INCREMENT de tabela `operadora_cartoes`
--
ALTER TABLE `operadora_cartoes`
  MODIFY `id_operadora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `parceiros`
--
ALTER TABLE `parceiros`
  MODIFY `id_parceiros` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `pastas`
--
ALTER TABLE `pastas`
  MODIFY `id_pasta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `perfil_usuario`
  MODIFY `id_perfil_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `tipo_contas`
  MODIFY `id_tipo_conta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `tipo_viagem`
--
ALTER TABLE `tipo_viagem`
  MODIFY `id_tviagem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de tabela `titulo_pagar`
--
ALTER TABLE `titulo_pagar`
  MODIFY `id_cpagar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de tabela `titulo_receber`
--
ALTER TABLE `titulo_receber`
  MODIFY `id_creceber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de tabela `users`
--
ALTER TABLE `users`
  MODIFY `id_usuario` int(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
