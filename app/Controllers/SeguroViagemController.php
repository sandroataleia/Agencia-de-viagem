...
class SeguroViagemController extends BaseController
{
  protected $mVenda;
  ...
  public function formulario_adicionar()
  {
    ...
    return view('seguro_viagem/adicionar', $data);
  }
  ...
  public function adicionar()
  {
    ...
    $data_venda = [
      ...
      'tipo_venda'            => 'Seguro Viagem',
      'incio_vigencia'        => $this->request->getPost('incio_vigencia'),
      'fim_vigencia'          => $this->request->getPost('fim-vigencia'),
