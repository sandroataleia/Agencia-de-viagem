            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    <div class="col-sm-7">
                      <h5><i class="fa fa-plus-circle"></i> LANÇAR VENDA DE PASSAPORTE</h5>
                    </div>
                  ...
                  <form action="<?= base_url('vendas/seguro_viagem/adicionar') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-sm-3 mb-1">
                        <div class="form-group">
                          <label for="Nome">Emissão</label>
                          <input name="emissao" class="form-control input-md" type="date" required>
                        </div>
                      </div>
                      <div class="col-sm-3 mb-1">
                        <div class="form-group">
                          <label for="Nome">Validade</label>
                          <input name="validade" class="form-control input-md" type="date" required>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label for="Nome">Protocolo</label>
                          <input name="protocolo" placeholder="protocolo" class="form-control input-md" type="text" required>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label for="Nome">Local retirada</label>
                          <input name="retirada" placeholder="local retirada" class="form-control input-md" type="text" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
