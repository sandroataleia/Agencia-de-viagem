            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    <div class="col-sm-7">
                      <h5><i class="fa fa-plus-circle"></i> LANÇAR VENDA DE CRUZEIRO</h5>
                    </div>
                  ...
                  <form action="<?= base_url('vendas/seguro_viagem/adicionar') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-sm-6 mb-1">
                        <div class="form-group">
                          ...
                          <input name="origem" required class="form-control input-md" type="text">
                        </div>
                      </div>
                      <div class="col-sm-6 mb-1">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-sm-3 mb-1">
                        <div class="form-group">
                          <label for="Nome">Início da vigência</label>
                          <input name="inicio_vigencia" class="form-control input-md" type="date" required>
                        </div>
                      </div>
                      <div class="col-sm-3 mb-1">
                        <div class="form-group">
                          <label for="Nome">Fim da vigência</label>
                          <input name="fim_vigencia" class="form-control input-md" type="date" required>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label for="Nome">Empresa navio</label>
                          <input name="empresa_navio" placeholder="nome" class="form-control input-md" type="text">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-3 mb-1">
                        <div class="form-group">
                          ...
                          <input name="valor" placeholder="R$ 1815,88" class="form-control input-md" type="text" required>
                        </div>
                      </div>
                    </div>
