                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <h5><i class="fa fa-plus-circle"></i> ALUGUEL DE QUARTO DE HOTEL</h5>
                                        </div>
                                ...
                                <div class="card-body">
                                  <form action="<?=base_url('vendas/aluguel_hotel/adicionar')?>"  method="post" enctype="multipart/form-data">
                                    <div class="row">
                                    ...
                                    <div class="row"> 
                                      <div class="col-sm-3 mb-1">
                                        <div class="form-group">
                                          <label for="Nome">Data do checkin</label>  
                                          <input name="vigencia_inicio" class="form-control input-md"  type="date" required>
                                        </div>
                                      </div>
                                      <div class="col-sm-3 mb-1">
                                        <div class="form-group">
                                          <label for="Nome">data do checkout</label>  
                                          <input name="vigencia_fim" class="form-control input-md"  type="date" required>
                                        </div>
                                      </div>
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                          <label for="Nome">Hotel</label>  
                                            <input name="hotel" placeholder="nome" class="form-control input-md"  type="text">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row"> 
                                      ...
                                      <div class="col-sm-3 mb-1">
                                        <div class="form-group">
                                          ...
                                          <input name="valor" placeholder="R$ 725,36" class="form-control input-md"  type="text" required>
                                        </div>
                                      </div>
                                    </div>
