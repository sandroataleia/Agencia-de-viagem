            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    <div class="col-sm-7">
                      <h5><i class="fa fa-plus-circle"></i> LANÇAR VENDA DE ALUGUEL DE CARRO</h5>
                    </div>
                ...
                <div class="card-body">
                  <form action="<?= base_url('vendas/aluguel_carro/adicionar') ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-sm-3 mb-1">
                        <div class="form-group">
                          <label for="Nome">Data do inicio da vigência</label>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label for="Nome">Concessionária</label>
                          <input name="concessionaria" placeholder="nome" class="form-control input-md" type="text">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6 mb-1">
                        <div class="form-group">
                          <label for="Nome">Local Retirada</label>
                          <input name="retirada" class="form-control input-md" type="text" required>
                        </div>
                      </div>
                      <div class="col-sm-6 mb-1">
                        <div class="form-group">
                          <label for="Nome">Local Entrega</label>
                          <input name="entrega" class="form-control input-md" type="text" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-3 mb-1">
                        <div class="form-group">
                          ...
                          <input name="valor_liquido" placeholder="R$ 725,36" class="form-control input-md" type="text" required>
                        </div>
                      </div>
                    </div>
