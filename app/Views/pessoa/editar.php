<div class="modal fade" id="editPessoa" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myLargeModalLabel">Editar Pessoa</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
      </div>
      <form id="form_pessoa" method="post" action="<?=base_url('pessoa/update')?>">
              ...
              <section>
                <div class="card p-3">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 mb-3">
                          <div class="form-group">
                            <input id="id" name="id" placeholder="" type="hidden">
